...
"#;
    ...
    #[test]
    fn completes_case_keyword_on_fun_param() {
        let src = r#"
enum Opt[T]:
  case Some(x: T)
  case None
...
"#;
    ...
    fn completes_kit_prefix() {
        for (typed, expect) in [
            ...
            ("Json.d", "Json.dropAt"),
            ("Json.f", "Json.floatOr"),
            ("Json.g", "Json.getFloat"),
            ("List.zi", "List.zipWithIndex"),
            ("List.un", "List.unzip"),
            ("List.fo", "List.foldLeft"),
            ("List.fo", "List.foldRight"),
            ("List.sc", "List.scanLeft"),
            ("List.sc", "List.scanRight"),
            ("List.red", "List.reduceLeft"),
            ("List.red", "List.reduceRight"),
            ...
            ("List.di", "List.diff"),
            ("List.distinctB", "List.distinctBy"),
            ("List.toM", "List.toMap"),
            ("List.toS", "List.toSet"),
            ...
            ("Stream.ra", "Stream.range"),
            ("Stream.re", "Stream.repeatN"),
            ("Stream.zi", "Stream.zip"),
            ("Stream.zi", "Stream.zipWithIndex"),
            ("Stream.in", "Stream.intersperse"),
            ("Stream.in", "Stream.interleave"),
            ("Stream.gr", "Stream.grouped"),
            ("Stream.fl", "Stream.flatten"),
            ("Stream.fl", "Stream.flatMap"),
            ("Stream.sc", "Stream.scan"),
            ("Stream.fo", "Stream.fold"),
            ("Stream.fo", "Stream.forall"),
            ("Stream.ch", "Stream.changes"),
            ("Stream.fi", "Stream.filterNot"),
            ("Stream.ma", "Stream.mapConcat"),
            ("Stream.zi", "Stream.zipWith"),
            ("Stream.zi", "Stream.zipAll"),
            ("Stream.or", "Stream.orElse"),
            ("Stream.sl", "Stream.sliding"),
            ("Stream.ta", "Stream.takeRight"),
            ("Stream.dr", "Stream.dropRight"),
            ("Stream.fi", "Stream.findLast"),
            ("Stream.ev", "Stream.evalTap"),
            ("Stream.it", "Stream.iterate"),
            ("Stream.un", "Stream.unfold"),
            ("Stream.he", "Stream.head"),
            ("Stream.la", "Stream.last"),
            ("Stream.co", "Stream.count"),
            ("Stream.no", "Stream.none"),
            ("Timeline.dr", "Timeline.driveHas"),
            ("Timeline.ne", "Timeline.nearestCheckpoint"),
            ("Timeline.ef", "Timeline.effectHas"),
            ("Timeline.ef", "Timeline.effectCount"),
            ("Timeline.fi", "Timeline.fiberLive"),
            ("Timeline.fa", "Timeline.faultKindHas"),
            ("Timeline.fa", "Timeline.faultN"),
            ("Timeline.ch", "Timeline.checkpoint"),
        ] {
