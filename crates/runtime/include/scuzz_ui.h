...
/* Watch an inject script (tap/text/pump/scroll). Next pump that sees new
 * contents plays the suffix (append) or the whole file (rewrite). Missing =
 * empty. */
 ...
 * (tap/text/pump/scroll) when that file changes. */
