...
SzIo *sz_net_serve_once(int64_t port, SzCont handler, void *env); /* IO[Unit]; one GET; 1s req read; 127.0.0.1 + ::1 */
SzIo *sz_net_serve(int64_t port, SzCont handler, void *env); /* IO[Unit]; keep listen; 1s req read; 127.0.0.1 + ::1 */
