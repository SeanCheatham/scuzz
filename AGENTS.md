...
- **No docs sprawl.** Do not add README/GUIDE/ARCHITECTURE files per crate “for completeness.” Stub crates may have a short README pointing at the phase; otherwise document in `docs/` or in code comments. Update existing docs instead of creating siblings.
