...
- Named types in signatures, enum fields, and aliases must resolve to a built-in type, an enum, a record, an alias, or a declared type parameter. A single capital letter can be an open type.
