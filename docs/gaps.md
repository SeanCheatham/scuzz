...
- **FS2-shaped `Stream`** — vision promises built-in Streaming; `Queue` is the closest primitive. Builtin pull/chunk combinators (Cats Effect / FS2 spirit, not a port), residual under TestRuntime. Next slice: [`plans.md`](plans.md).
