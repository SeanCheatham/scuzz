...
- **File-as-module** — stem namespaces + `private def` + `import Module.name` on Stage 0 and self-host (`examples/modules`). Later: enum-per-module. Records/traits/generics: [`compatibility.md`](compatibility.md).
