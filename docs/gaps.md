...
- **Property mining** — `scuzz mine` proposes claims from fuzz traces. A human accepts or dismisses each candidate. Accepted claims land in `intent.scuzz_intent`. See [`mine.md`](mine.md).
