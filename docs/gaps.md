...
- **Language surface** — richer generics beyond monomorphized defs/enums/records, record/enum methods, and generic `impl` on records and enums ([`compatibility.md`](compatibility.md)).
