...
- **Language surface** — richer generics beyond monomorphized defs/enums/records, record/enum methods, generic `impl` (including methods that mention `T`), and generic traits ([`compatibility.md`](compatibility.md)).
