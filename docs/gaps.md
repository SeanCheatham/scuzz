...
- **Language surface** — richer generics beyond monomorphized defs/enums/records, record/enum methods, generic `impl`, and `trait Get[T]` ([`compatibility.md`](compatibility.md)). Next: trait type args on impl.
