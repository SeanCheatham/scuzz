...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: drop a failed `Net.serve` write and keep listening — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
