...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: `scuzz watch` still only rebuilds — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
