...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: RFC 8305 IPv6 preference delay — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
