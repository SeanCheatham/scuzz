...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: mutate `*`/`/` inside residual oracles — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
