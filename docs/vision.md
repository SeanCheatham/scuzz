...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: dump live TextField contents — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
