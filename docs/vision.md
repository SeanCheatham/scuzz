...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: keep `Net.serve` listening after a timed-out client — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
