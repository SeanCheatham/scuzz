...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: methods on generic records — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
