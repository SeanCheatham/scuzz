...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: IPv6 literals for `Net.httpGet` — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
