...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: built-in mutation testing — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
