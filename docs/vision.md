...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: dump bindText in `[views]` — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
