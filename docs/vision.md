...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: DNS query timeout for `Net.httpGet` — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
