...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: `Net.serve` IPv6 listen — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
