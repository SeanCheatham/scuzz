...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: drop a malformed `Net.serve` client and keep listening — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
