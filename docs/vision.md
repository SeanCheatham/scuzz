...
Unknowns and known gaps: [`gaps.md`](gaps.md). Next slices: response write timeout for `Net.serve` — [`plans.md`](plans.md). Open unknowns: device Mobile (blocked on NDK/Xcode), GPU presenters.
