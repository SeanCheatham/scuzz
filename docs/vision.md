...
Self-hosting staged slices are in. The product CLI is Scuzz. Bootstrap fetches the newest GitHub `v*` release. Remaining device/GPU unknowns: [Self-hosting](#self-hosting) and [`gaps.md`](gaps.md). Product version lives in `VERSION`.
