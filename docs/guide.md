...
| `examples/studio` | Full UI app: `showWhen` pages, `Signal.list` + `View.each`, Done/Add/Del/Rename, `View.checkbox`, Fs load/save, `record` / `trait` / stem modules, laws + drivers / `Law.sometimes` |
